...
void shellSort(Show arr[], int n, int *comparacoes, int *movimentacoes) {
    int gap, i, j;
    Show temp;
...
int main() {
    ...
    shellSort(lista, tamLista, &comparacoes, &movimentacoes);
    ...
    FILE *log = fopen("845860_shellsort.txt", "w");
    if (log) {
