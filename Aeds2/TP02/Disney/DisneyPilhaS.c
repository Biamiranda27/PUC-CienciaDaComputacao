...
#define MAX_LIST 20
#define MAX_PILHA 1000  // define o tamanho máximo da pilha
...
// Criar show vazio, ler_show e buscar_linha_por_id permanecem os mesmos (como no seu código original)
