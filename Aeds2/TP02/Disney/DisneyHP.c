...
int comparar(Show a, Show b) {
    char tipoA[100], tipoB[100], tituloA[200], tituloB[200];
    normalizar(tipoA, a.type);
    normalizar(tipoB, b.type);
    normalizar(tituloA, a.title);
    normalizar(tituloB, b.title);

    int cmpTipo = strcmp(tipoA, tipoB);
    comparacoes++;
...
int main() {
    ...
    FILE *log = fopen("845860_heapsort.txt", "w");
